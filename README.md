## Backend-Focused Developer | Full-Stack Systems & Architecture

Technical focus on building reliable backend systems and modular architectures. Currently developing personal projects with a strong emphasis on type safety, scalability, and clean code.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge)](https://linkedin.com/in/kostiantyn-belei)
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>Main focus</h4>
      <ul>
        <li>Building real-world backend systems and architectures</li>
        <li>Improving system design and architecture skills</li>
        <li>Learning data modeling, state management, and performance</li>
      </ul>
      <h4/>
    </td>
    <td width="50%" valign="top">
      <h3>Exploring</h4>
      <ul>
        <li><b>Go</b> for high-performance networking</li>
        <li><b>C#</b> for enterprise-grade backend development.</li>
      </ul>
    </td>
  </tr>
</table>
